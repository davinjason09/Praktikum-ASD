        ...
        while (true) {
            ...
            while (true) {
                if (x.left == null && x.right == null) {
                    ...
                    if (YorN(isWord))
                        break; // Check if the word on your thought is the same as the one displayed
                    else { // If it's different with the item displayed
                        System.out.println("Beritahu Jawabannya!");
                        String answer = sc.nextLine();
                        System.out.printf(
                                "Masukkan pertanyaan yang jika dijawab YES adalah %s dan jika dijawab NO adalah %s%n",
                                answer, x.label);
